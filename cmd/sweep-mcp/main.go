...
func main() {
	...
	// plain round-robin Service would break that the moment a follow-up
	// lands on a different pod, blocking safe horizontal scaling. Matches
	// the fix already applied to the Python (FastMCP) wrappers'
	// stateless_http=True.
